...
% Open file
% fid = fopen('./remnant_measurements/triag/RMN_1200V_VAR.dat');
% fid = fopen('./remnant_measurements/triag/RMN_1400V_VAR.dat');
% fid = fopen('./remnant_measurements/triag/RMN_FADE_VAR.dat');
% fid = fopen('./remnant_measurements/trap/RMN_TRAP_1200V_VAR.dat');
% fid = fopen('./remnant_measurements/trap/RMN_TRAP_1400V_VAR.dat');

fid = fopen('./remnant_measurements/triag/RMN_1400V_1000V_VAR.dat');
% fid = fopen('./remnant_measurements/trap/RMN_TRAP_1400V_500V_VAR.dat');
% fid = fopen('./remnant_measurements/trap/RMN_TRAP_1400V_1000V_VAR.dat');
