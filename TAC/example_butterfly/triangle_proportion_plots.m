...
set(gca,'YTick',[],'YTickLabel',{},'TickLabelInterpreter','latex');
set(get(gca,'YLabel'),'Rotation',0);
set(get(gca,'YLabel'),'Position',get(get(gca,'Ylabel'),'Position')+[-0.425 0 0]);

axis('equal');
axis([-1.2 1.2 -1.5 0.6]);
...
ylabel('$u(t)$','fontsize',11,'interpreter','latex');
set(gca,'XTick',[T1,T2,T3,T4,T5],...
    'XTickLabel',{'$t_1$','$t_2$','$t_3$','$t_4$','$t_5$'},...
    'fontsize',10,'TickLabelInterpreter','latex');
...
legend({'$\mathcal{P}(u,L_0)(t)\ |\ t_1 \leq t < t_2$'...
    ...
    'interpreter','latex');
xlabel('$t$','fontsize',11,'interpreter','latex');
ylabel('$\mathcal{P}(u,L_0)(t)$','fontsize',11,'interpreter','latex');
set(gca,'XTick',[T1,T2,T3,T4,T5],...
    'XTickLabel',{'$t_1$','$t_2$','$t_3$','$t_4$','$t_5$'},...
    'fontsize',10,...
    'TickLabelInterpreter','latex');
